...
export const Book = ({
  ...
  return (
    <div className="inline-block w-fit" style={{ perspective: 900 }}>
      <div
        className="aspect-[49/60] w-fit relative duration-[250ms] book-rotate"
      ...
      >
        ...
        >
          {coverUrl ? (
            ...
            /* Generic book: colored stripe + text */
            <>
              <div
              ...
              >
                ...
                <div
                  className={clsx(
                    ...
                    variant === "simple" ? "gap-2" : "justify-between"
                  )}
                  style={{
                    containerType: "inline-size",
                    gap:
                      variant === "simple"
                        ? `calc((16px / 196) * ${_width})`
                        : undefined,
                  }}
                >
                  <div className="flex flex-col gap-[0.4em]">
                    ...
                    {author && (
                      <span
                        className={clsx(
                          "leading-[1.2em] tracking-[-.01em]",
                          variant === "simple" ? "text-[9cqw]" : "text-[8.5cqw]"
                        )}
          ...
          {textured && (
            <div className="absolute top-0 left-0 inset-0 rotate-180 rounded-l-md rounded-r mix-blend-hard-light pointer-events-none bg-cover bg-no-repeat opacity-50 brightness-110" />
          )}
        </div>
