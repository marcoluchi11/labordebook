    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div>
        ...
        {errors.emailConfirm
          ...
          : <p className="text-xs text-gray-400 mt-1">{isGift ? 'Te enviaremos la confirmación a este email.' : 'Te enviaremos el acceso al libro a este email.'}</p>
        }
      </div>
        ...
        <div className="space-y-4 bg-amber-50 border border-amber-200 rounded-lg px-4 py-4">
          ...
          <div>
            ...
            {errors.recipientEmailConfirm
              ...
              : <p className="text-xs text-gray-500 mt-1">El acceso al libro le llegará a este email.</p>
            }
          </div>
        </div>
      )}
